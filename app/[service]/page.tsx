...
//   // If service doesn't exist, show 404 or redirect
...
//   if (!serviceData) {
//     return {
//       title: 'Service Not Found - Chargeback',
//       description: 'The requested cancellation guide could not be found.',
//     };
//   }
...
//     keywords: `cancel ${serviceData.name}, ${serviceData.name} cancellation, how to cancel ${serviceData.name}, ${serviceData.name} refund`,
//   };
// }
import CancellationGuidePage from '../components/CancellationGuidePage';
import servicesData from '@/servicesData.json';
